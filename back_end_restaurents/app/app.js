...
const route_restaurant_communication = require('./api/routes/communication/restaurants')
const route_restaurantAdd_communication = require('./api/routes/communication/restaurentAdd')


/*********date base connection it will shut down every 5min you need to restart it*************************/
  client.connect(function(err) {
    if (err){
        console.log(err.message + "error connecting with database")
    }else{
...
/************************************/
app.use("", route_restaurant_communication)
app.use("", route_restaurantAdd_communication)
